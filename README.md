<div align="center">
  ...
  <img src="(https://raw.githubusercontent.com/)MilsonElias/mapos/blob/master/docs/dashboard.jpg)" alt="Map-OS Dashboard" width="100%" style="border-radius: 16px; box-shadow: 0 4px 20px rgba(0,0,0,0.15);" />
